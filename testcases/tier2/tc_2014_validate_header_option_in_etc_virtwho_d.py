...
class Testcase(Virtwho):
    def test_run(self):
        ...
        self.vw_case_info(case_name, "RHEL-136585")
        ...
        self.vw_option_update_name(option_tested, "[ ]", conf_file)
        ...
        self.vw_option_update_name(option_tested, '[红帽€467aa]', conf_file)
        data, tty_output, rhsm_output = self.vw_start()
        res1 = self.op_normal_value(data, exp_error=0, exp_thread=1, exp_send=1)
...
#- Case created to validate header option
#- libvirt-local mode will be used to instead when header option is null or disable
