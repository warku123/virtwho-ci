...
class Testcase(Virtwho):
    def test_run(self):
        ...
        self.vw_case_info(case_name, "RHEL-136591")
...
#- password null value is acceptable for /etc/virt-who.d/, error msg is: Unable to login
#- password null value is not acceptable for /etc/sysconfig/virt-who, error msg is: USERNAME.* not set,
