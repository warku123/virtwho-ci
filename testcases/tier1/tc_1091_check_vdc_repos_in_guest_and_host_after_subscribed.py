...
class Testcase(Virtwho):
    def test_run(self):
        ...
        self.vw_case_info(case_name, "RHEL-134055")
        ...
        if "libvirt-local" in mode or "vdsm" in mode:
            ...
            logger.warning("skip this step, it's not available for mode %s" % mode)
...
#- Case created to check repo status in guest and host after subscribed
