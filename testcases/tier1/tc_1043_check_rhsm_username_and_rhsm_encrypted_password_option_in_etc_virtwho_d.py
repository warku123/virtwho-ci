...
class Testcase(Virtwho):
    def test_run(self):
        ...
        self.vw_case_info(case_name, "RHEL-133712")
        ...
        self.vw_option_add("rhsm_encrypted_password", encrypted_value, filename=conf_file)
        data, tty_output, rhsm_output = self.vw_start(exp_send=1)
        res = self.op_normal_value(data, exp_error=0, exp_thread=1, exp_send=1)
...
#- Case created to validate rhsm_username and rhsm_encrypted_password
