...
class Testcase(Virtwho):
    def test_run(self):
        ...
        self.vw_case_info(case_name, "RHEL-133733")
        ...
        cmd = 'cat %s >> %s && rm -rf %s' % (extra_file, conf_file, extra_file)
        ret, output = self.runcmd(cmd, self.ssh_host(), desc="cat file")
...
# - Case created to validate create one config file with two hypervisors by virt-who.d
